...
class RecipeImageUploadtests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Sambhar Curry')
        recipe2 = sample_recipe(user=self.user, title='Chicken Biriyani')
        tag1 = sample_tag(user=self.user, name='Vegetarian')
        tag2 = sample_tag(user=self.user, name='Main Course')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Al Faham')
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Schezwan Fried Rice')
        recipe2 = sample_recipe(user=self.user, title='Schezwan chicken')
        ingredient1 = sample_ingredient(user=self.user, name='Rice')
        ingredient2 = sample_ingredient(user=self.user, name='Chicken')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)

        recipe3 = sample_recipe(user=self.user, title='Chicken Steak')
